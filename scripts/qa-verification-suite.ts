...
assert(pkgJson.version === '3.0.0', suite1, 'package.json version is 3.0.0', `Found ${pkgJson.version}`);
assert(APP_VERSION === 'v3.0.0', suite1, 'version.ts APP_VERSION is v3.0.0', `Found ${APP_VERSION}`);
