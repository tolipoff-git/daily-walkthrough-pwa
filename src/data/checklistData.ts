...
export const CHECKLIST_ITEMS_TEMPLATE: ChecklistItem[] = [
  ...
  },
  {
    ...
    categoryTitleRu: 'Производственная зона и 5S',
    categoryTitleEn: 'Shop Floor & Workstations (5S)',
    titleRu: '2.4. Защита оборудования, СИЗ (PPE) и E-Stop',
    titleEn: '2.4. Machine Guarding, PPE & E-Stops',
    standardRu: 'Защитные кожухи на месте, кнопки E-Stop доступны; соблюдается стандарт СИЗ FSE (очки Z87.1, лицевой щиток только поверх очков, защита слуха, спецобувь).',
    standardEn: 'Protective guards & E-Stops operational; FSE PPE standards enforced (Z87.1 safety glasses, face shields worn WITH glasses underneath, hearing & foot protection).',
    guidelinesRu: [
      'Защитные очки (ANSI Z87.1) на всех сотрудниках в цехе; линзы чистые, без сколов и глубоких царапин',
      'Правило FSE: Лицевой щиток используется ТОЛЬКО поверх защитных очков (щиток сам по себе не заменяет очки)',
      'Защита слуха при работе с пилами, ударным и шумным инструментом; защитная обувь с подноском от падения деталей',
      'Кожухи приводов и шпинделей зафиксированы, грибовидные кнопки E-Stop легкодоступны и не загорожены',
    ],
    guidelinesEn: [
      'ANSI Z87.1 approved safety glasses worn at all times; lenses clean, unpitted, and unscratched',
      'FSE Rule: Face shields must ALWAYS be worn WITH safety glasses underneath (a face shield alone is NOT eye protection)',
      'Hearing protection worn in saw/impact tool areas; protective steel/composite toe footwear verified',
      'All interlocked machine guards intact; mushroom E-Stop buttons clear and instantly accessible',
    ],
    status: 'PENDING',
  },
  {
    ...
    categoryTitleRu: 'Производственная зона и 5S',
    categoryTitleEn: 'Shop Floor & Workstations (5S)',
    titleRu: '2.5. Химикаты (HazCom / GHS), промывка глаз и аптечки',
    titleEn: '2.5. Chemicals (OSHA HazCom / GHS), Eyewash & Spill Kits',
    standardRu: 'Химикаты маркированы по стандарту GHS (6 элементов); паспорта SDS на английском языке доступны; станции промывки глаз свободны.',
    standardEn: 'Chemicals labeled to OSHA 29 CFR 1910.1200 / GHS (6 mandatory elements); 16-section English SDS accessible; eyewash stations clear.',
    guidelinesRu: [
      'Вся вторичная тара (бутылки, масленки, спреи) имеет этикетку GHS: Название, DANGER/WARNING, пиктограммы, фразы опасности, меры предосторожности, контакт производителя',
      'Паспорта безопасности (SDS) из 16 разделов доступны на английском языке на рабочих местах',
      'Поддоны-уловители проливов чистые и сухие; раздельное хранение несовместимых химикатов (окислители отдельно)',
      'Станции промывки глаз и аптечки доступны за 10 секунд, не загромождены (клиренс 90 см), бирки проверок заполнены',
    ],
    guidelinesEn: [
      'All secondary containers labeled per OSHA HazCom: Product ID, DANGER/WARNING signal word, GHS pictograms, Hazard & Precautionary statements, Manufacturer info',
      '16-section Safety Data Sheets (SDSs) readily available in English for all active chemicals before use',
      'Spill containment pallets clean, dry, and compliant; oxidizers and flammables segregated',
      'Eyewash stations and first aid kits unobstructed (36" clearance), operational, and monthly inspection tags verified',
    ],
    status: 'PENDING',
  },
...
export function createNewInspectionSession(lang: Language = 'ru'): InspectionSession {
  ...
  const role = savedRole || defaultPerson?.role || (lang === 'ru' ? defaultRoleRu : defaultRoleEn);
